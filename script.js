...
let songs = [
  ...
  { time: 220.8, text: "Lays me down with my mind she runs" },
  { time: 415.2, text: "Throughout the night" },
  { time: 620.4, text: "No need to fight" },
  { time: 819.6, text: "Never a frown with golden brown" },
  { time: 1002.0, text: "Every time just like the last" },
  { time: 1206.0, text: "On her ship tied to the mast" },
  { time: 1404.0, text: "To distant lands" },
  { time: 1604.4, text: "Takes both my hands" },
  { time: 1803.6, text: "Never a frown with golden brown" },
  { time: 2001.6, text: "Golden brown finer temptress" },
  { time: 2199.6, text: "Through the ages she's heading West" },
  { time: 2398.8, text: "From far away" },
  { time: 2598.0, text: "Stays for a day" },
  { time: 2796.0, text: "Never a frown with golden brown" },
  { time: 2995.2, text: "Never a frown" },
  { time: 3193.2, text: "With golden brown" },
  { time: 3391.2, text: "Never a frown" },
  { time: 3589.2, text: "With golden brown" },
  { time: 3787.2, text: "" }
]
    },
        {
